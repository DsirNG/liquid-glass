...
- Documented the locked public API for Vanilla JavaScript and Vue 3.
- Documented capability-driven browser selection, fallback policies, and parameter support levels.
- Added the canonical Playwright visual environment and runtime observability guidance to the
